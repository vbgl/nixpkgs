...
rec {
  ...
  textutils_kernel = janePackage {
    ...
    propagatedBuildInputs = [ core_kernel ];
    meta.description = "Subset of textutils using only core_kernel and working in javascript";
  };
  ...
  async_rpc_kernel = janePackage {
    ...
    propagatedBuildInputs = [ protocol_version_header async_kernel ];
  ...
  ecaml = janePackage {
    ...
    propagatedBuildInputs = [ expect_test_helpers_kernel ];
  ...
  email_message = janePackage {
    ...
    buildInputs = [ angstrom ounit ];
    propagatedBuildInputs = [ async angstrom core_extended cryptokit magic-mime ];
